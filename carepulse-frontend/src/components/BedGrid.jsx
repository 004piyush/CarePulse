...
import { STATUS_BG_COLORS, STATUS_LABELS, VALID_TRANSITIONS, BED_STATUS } from '../data/mockData';
      ...
      {beds.map((bed) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  {bed.ward || bed.wardType} Ward {bed.floor ? `• Floor ${bed.floor}` : ''}
                </p>
              </div>
              <span
                className={`
            ...
            {(bed.status === BED_STATUS.OCCUPIED || bed.status === BED_STATUS.RESERVED) && patient && (
            ...
            <div className="flex items-center gap-1.5 text-[10px] text-slate-400 mb-2">
              ...
              Updated {bed.lastUpdated ? new Date(bed.lastUpdated).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'recently'}
            </div>
